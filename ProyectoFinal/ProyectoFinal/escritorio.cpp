...
int main()
{
   ...
   /* Model pokearriba((char*)"Models/Pokeball2/pokearriba.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc, lightPos.x + movelightPos, 0, lightPos.z + movelightPosT);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 1.0f, 0.5f, 0.5f);
        ...
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.12, 0.630f, 0.007568f);
        ...
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.0f, 0.05f, 0.0000f);
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.4f, 0.5f, 0.4f);
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.04f, 0.7f, 0.7f);
        //glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 0.078125f);
        //model = glm::mat4 (1);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(movelightPos+0.0f, 0.0f, movelightPosT + 0.0f) );
